...
export function JobDetailsModal({ job, isOpen, onClose }: JobDetailsModalProps) {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-md bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 border-2 border-blue-600 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
