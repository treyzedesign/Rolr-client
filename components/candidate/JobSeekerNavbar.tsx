...
export function JobSeekerNavbar({ onMobileMenuToggle }: JobSeekerNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-blue-100 bg-white/95 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90">
